...
public class IA_ALONSO {
    ...
    public static void calculadorAutomatico(){
        ...
        contador_Nomun = (int) (Math.random() * 200) + 1; // Gaston funcion random (debe de modular)
        ...
        double distancia = (int) (Math.random() * 200) + 1; // Añadir random de distancia
        ...
        // 7) Vehículos utilizados (mostrar vehículos)
        System.out.println(Text.guiones);
        System.out.println(Text.accion + " 7");

        // Mostrar los vehículos
        System.out.println("Vehículos utilizados:");
        for (Vehiculo vehiculo : Text.listVehiculo) {
